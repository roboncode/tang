...
class Schema {
  ...
  validate(data, options) {
    ...
    if(options.required) {
      ...
      if(required === 'create') {
        joi = joi.requiredKeys(this._requiredKeys.create)
      } else if(required === 'update') {
        console.log('we are here', this._requiredKeys.update)
        joi = joi.requiredKeys(this._requiredKeys.update)
      } else {
        joi = joi.requiredKeys(this._requiredKeys.all)
      }
    }
